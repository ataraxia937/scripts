...
sudo dnf -y install atuin cargo clippy dotnet-sdk-8.0 gh golang google-chrome-stable node restic rust-src rustfmt shellcheck typescript vim-default-editor yarnpkg
