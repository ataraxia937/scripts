...
sudo dnf -y install cargo dotnet-sdk-8.0 gh golang google-chrome-stable node pylint restic rust-src rustfmt shellcheck typescript vim-default-editor yarnpkg
