...
sudo apt -y install apt-file build-essential curl flatpak fonts-noto gawk git gnome-console gnome-shell-extension-dashtodock podman python3-venv restic vim wl-clipboard xxd
