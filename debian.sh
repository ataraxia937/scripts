...
sudo apt -y install apt-file build-essential curl fd-find flatpak fonts-noto fzf gawk git gnome-console gnome-shell-extension-dashtodock luarocks needrestart-session podman python3-pip python3-pynvim python3-venv restic ruby ruby-dev sqlite3 vim wl-clipboard xxd
